...
class Student:
    def __init__(self,root):
        ...
        # first image
        img = Image.open(r"C:/Users/sharm/OneDrive/Desktop/Face Recognition System/College_Images/college_images/face-recognition.png")
        ...
        # second image
        img1 = Image.open(r"C:/Users/sharm/OneDrive/Desktop/Face Recognition System/College_Images/college_images/smart-attendance.jpg")
        ...
        # third image
        img2 = Image.open(r"C:/Users/sharm/OneDrive/Desktop/Face Recognition System/College_Images/college_images/1.jpg")
        ...
        f_lbl.place(x=1000,y=0,width=500,height=130)
         ...
         # background image
        bgimg = Image.open(r"C:/Users/sharm/OneDrive/Desktop/Face Recognition System/College_Images/college_images/bgimg.jpg")
        ...
        left_frame.place(x=10,y=10,width=730,height=580)
         ...
         # third image
        img_left = Image.open(r"C:/Users/sharm/OneDrive/Desktop/Face Recognition System/College_Images/college_images/1002.jpg")
        ...
        course.place(x=5,y=135,width=700,height=117)
        ...
        class_student.place(x=5,y=250,width=700,height=300)
        ...
        student_add_lbl.grid(row=4,column=2,padx=10,pady=5,sticky=W)
        
        student_add_entry=ttk.Entry(class_student,textvariable=self.var_address,width=20,font=("times new roman",10,"bold"))
        student_add_entry.grid(row=4,column=3,padx=10,pady=5,sticky=W)
        ...
        student_dob_lbl.grid(row=3,column=2,padx=10,pady=5,sticky=W)
        ...
        student_dob_entry.grid(row=3,column=3,padx=10,pady=5,sticky=W)
        ...
        btn_frame.place(x=0,y=200,width=700,height=70)
        
        save_btn=Button(btn_frame,text="Save",command=self.add_data,font=("times new roman",15,"bold"),bg="blue",fg="white",width=14)
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Update",command=self.update_data,font=("times new roman",15,"bold"),bg="blue",fg="white",width=14)
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,font=("times new roman",15,"bold"),bg="blue",fg="white",width=14)
        ...
        take_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",font=("times new roman",15,"bold"),bg="blue",fg="white",width=30)
        take_btn.grid(row=1,column=0)
        
        up_photo_btn=Button(btn_frame1,text="Update Photo Sample",command=self.update_dataset,font=("times new roman",15,"bold"),bg="blue",fg="white",width=30)
        ...
        img_right = Image.open(r"C:\Users\sharm\OneDrive\Desktop\Face Recognition System\College_Images\college_images\100.jpg")
        img_right = img_right.resize((454,130),Image.ANTIALIAS)
    ...
    def add_data(self):
        ...
        pattern1='^[a-z 0-9]+[\._]?[a-z 0-9]+[@]\w+[.]\w{2,3}$'
        z=re.search(pattern,str(self.var_email.get()))
        y=re.search(pattern1,str(self.var_email.get()))
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_student_id.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        elif ((z is None) and (y is None)):
            messagebox.showerror("Error","Invalid mail id",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="13579135",database="face_recognizer")
            ...
            try:
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path="C:/Users/sharm/OneDrive/Desktop/Face Recognition System/Data/"
        ...
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.var_student_id.get()=="":
            ...
            try:
                ...
                if myresult:
                    ...
                    Id+=1
                mycursor.execute("update student set Department=%s, Course=%s, Year=%s, Semester=%s, Student_ID=%s, Name=%s, Division=%s, RollNo=%s, Gender=%s, DOB=%s, Email=%s, Phone=%s, Address=%s, Teacher_Name=%s, PhotoSampleStatus=%s where Student_ID=%s",(self.var_dep.get(),self.var_course.get(),self.var_year.get(),self.var_semester.get(),self.var_student_id.get(),self.var_name.get(),     self.var_div.get(),self.var_roll_no.get(),self.var_gender.get(),self.var_dob.get(),self.var_email.get(),self.var_phone.get(),self.var_address.get(),
                                                                                                          self.var_teacher.get(),self.var_radio1.get(), self.var_student_id.get()==Id))
                conn.commit()
                self.fetch_data()
                self.reset_data()
                conn.close()
